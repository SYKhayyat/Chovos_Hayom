...
| §1 App name, launcher icon (generated by `tool/generate_icon.py`), Windows window/exe name | `1d4ba71` |
...
| §1 `allowBackup` off + data-extraction rules (Android was set to ship the DB to Google) | `1d4ba71` |

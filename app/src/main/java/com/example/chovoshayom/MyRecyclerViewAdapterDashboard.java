...
public class MyRecyclerViewAdapterDashboard extends RecyclerView.Adapter<MyRecyclerViewAdapterDashboard.ViewHolder> {
    ...
    MyRecyclerViewAdapterDashboard(Context context, String[] data) {
